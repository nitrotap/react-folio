    ...
    const projectList = [
        {
            ...
            description: `Mental Health Check is a quiz app that helps users identify their feelings and directs them to helpful resources.
            `
        },
        {
            ...
            description: `A travel guide to hidden spots across the United States. Find the offbeat, see something interesting, and share it with others!`
        },
        {
            ...
            description: `A simple password generator using inquirer and node.js.`
        },
        {
            name: 'Code Quiz',
        ...
        },
        {
            ...
            description: `A Progressive Web Application (PWA) for tracking your budget. This app is installable on your phone or computer and can track your budget online and offline. Offline transactions are uploaded to the database when the connection to the internet is re-established.`
        },
        {
            name: 'Line Mash',
